...
/* ============================================================
   ...
   异次元的蕾雅。这一记的名字与台词取 v4 特典
   『与少女许下永恒的约定的那一天』—— 那一天从凌晨四点忙到次日凌晨两点，
   婚礼、婚宴、琉米爱尔家的第二场，最后只剩他们两个人的那间房：
     「——我们会一直在一起的，直到死亡将我们分离。」
     「我也爱你，小言。那么我这一生，也会为你而活。这样才公平对吧？」
   那是心叶与蕾雅之间**立过的那一件事**本身。arms.ts 里那两枚成对的戒指
   （「a Session.」——「两枚成对的戒指相互共鸣，能让佩戴者灵魂共奏、合而为一」）
   就是这件事的形状；蕾雅的「热沃当的少女」也写着同一句：
   「直到她在篝火之国与心叶立下「a Session.」的共奏之约，这把锯子才第一次学会
   为守护而转动」。在那个「露娜小姐已死」的世界里，心叶没能停下终末，
   却照样与她立过那个约 —— 所以他把亡灵军团喊回来的那一刻，那两枚戒指又对上了。
...
export const RIVAL_LINK = {
  ...
  link: {
    name: '与少女许下永恒的约定的那一天',
    desc: '「——我们会一直在一起的，直到死亡将我们分离。」'
      + '那一天立下的那件事，在另一个次元也照样算数：锯齿转到该守的那一侧，'
      + '低语读出的位置与它合在同一个方向上 —— 两个人、一手，落下来。'
      + '（原文口径：v4 特典『与少女许下永恒的约定的那一天』；'
      + 'arms.ts「a Session.」与蕾雅的「热沃当的少女」两条。）',
    line: '「——我们会一直在一起的，直到死亡将我们分离。」「……嗯。」',
    power: LINK_SHARE,
    linkPow: LINK_SHARE,
