/* ============================================================
   ...
   平衡读数（RUNS=200，同一套种子矩阵逐项比）：中盘份额 19%→21%（危险度≥5 那张）、
   16%→19%（全部场次），卷末 10%→13% / 9%→12%，总体胜率 76%→79% / 75%→80%。
   ⚠️ 主人先前为「一个人打一支队」两次收过他的意志力与反现实亲和（见下面两处时期注）
   —— 这一档会把那件事顶回来一点，份额若再往上走，该收的是别处，不是把这一手再抬回去。
