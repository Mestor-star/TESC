...
export const ARM_TRADITIONS: {
  ...
  {
    kind: '特殊武器',
    sub: 'ARTIFACTS · OFF-LINEAGE',
    school: '系谱之外 · 造物／遗物',
    color: '#ffb347',
    statue: '无授予者——不属于三学园任何一尊天使石像的赠予。它们是被造出来的：以神明的躯体为材料，或在更古老的战场上遗落，再经人手辗转。',
    basis: '无统一基型——形态即功能本身。归类于此的唯一标准是：它不是天使给的。',
    note: '弹痕、斩击、片羽皆为「渴望被授予之后的具象」，会随持有者的心而变形；造物则不问持有者的渴望，它只是被交到某人手里。',
    quote: '「动手——爪。」',
  },
]
...
export const ARMS: ArmEntry[] = [
  /* ———————— 弹痕 · 苍之学园 ———————— */
  {
    ...
    power: '恋兔光从掌心召唤出的纯白吉他。它在弗尔克图斯拥有超群的威力，成因却无人知晓——'
  ...
  /* ———————— 特殊武器 · 系谱之外 ———————— */
  {
    id: 'lin-claw', kind: '特殊武器', name: '爪', sub: 'CLAW · SUSPENDED 3D PRINTER',
    holder: '小柴琳', holderNote: '苍之学园 · 恋兔队（原 境界领域商会 天才研究员）',
    holderId: 'xiaochai-lin',
    phrase: '「是我收纳在体内的悬浮3D打印机。」',
    power: '收纳于琳体内的悬浮 3D 打印机，能用激光把照射到的物质塑造成任意形状——木墙、乐器、通行证皆可当场造出，'
      + '亦可精准击落无人机。它带着可爱的表情飘飘忽忽地浮在她身边，会回应她的呼喝：「上吧。爪！」',
    awakened: '其材料并非凡物：「这玩意是用存在于遥远彼方的神明为材料制成的……不是能解析然后再现出来的替代品。」'
      + '——以某个旧神的神经制成的特别型号，「即使在境界领域商会也是独一无二的」。',
    ref: 'V5',
  },
]
