/* ============================================================
   ...
   与 `TimelineEvent.gate` 的关系：gate 拦的是**入口**。v1-9 上原本挂着一道
   「露娜 ≥ 70 才让进」，**主人 2026-09-16 把它撤了** —— 黄金狮子那一段不再
   因为好感不够而开不了。机制本身留着（别的段要拦入口照样能挂），只是当前
   一段门槛都没有。锁定那一档（`lock`）不受影响，仍锁 100。
   ============================================================ */
