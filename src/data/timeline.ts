...
const v1: Evt[] = [
  {
    id: 'v1-1', group: '卷1', order: 1, phase: '序章', day: '第 0 日',
  ...
  {
    id: 'v1-4', group: '卷1', order: 4, phase: '第 1 章', day: '第 1 日',
  ...
  {
    id: 'v1-5', group: '卷1', order: 5, phase: '第 2 章', day: '第 2 日',
  ...
  {
    id: 'v1-6', group: '卷1', order: 6, phase: '第 2 章', day: '第 3 日',
  ...
  {
    id: 'v1-7', group: '卷1', order: 7, phase: '第 3 章', day: '第 5 日',
  ...
  {
    id: 'v1-8', group: '卷1', order: 8, phase: '第 4 章', day: '第 7 日',
  ...
  {
    id: 'v1-9', group: '卷1', order: 9, phase: '终章', day: '第 10 日',
...
const v2: Evt[] = [
  ...
  {
    id: 'v2-4', group: '卷2', order: 4, phase: '第 4 话', day: '',
  ...
  {
    id: 'v2-7', group: '卷2', order: 7, phase: '第 9 话', day: '',
  ...
  {
    id: 'v2-8', group: '卷2', order: 8, phase: '第 10 话', day: '',
  ...
  {
    id: 'v2-9', group: '卷2', order: 9, phase: '尾声', day: '',
...
const v3: Evt[] = [
  {
    id: 'v3-1', group: '卷3', order: 1, phase: '序章', day: '',
  ...
  {
    id: 'v3-2', group: '卷3', order: 2, phase: '第 1 话', day: '',
  ...
  {
    id: 'v3-3', group: '卷3', order: 3, phase: '第 2 话', day: '',
  ...
  {
    id: 'v3-4', group: '卷3', order: 4, phase: '第 3 话', day: '',
    title: '永田町地下 · 骷髅假面之男', place: '永田町地下300米 · 异厅怪异研究所',
    summary: '恋兔队随会长赴异厅会谈。深夜露娜独自买烟，遭一名戴骷髅面具、自认「你的同伴」的神秘男拦路——他赠她通往异次元的「通行证」劝她逃走，'
      + '并以复活的半透明「小蕾雅」之电锯断后遁入亚空间。露娜拒绝跳入「喜望峰的大口」，回到心叶身边。',
    entities: ['NO.19 喜望峰的大口'], chars: ['luna', 'hikari', 'mefisa', 'nyau'],
    bond: B({ hikari: 91, luna: 97, mefisa: 90, nyau: 82 }),
  },
  {
    id: 'v3-5', group: '卷3', order: 5, phase: '第 4 话', day: '',
    title: '魔王夜袭与「婚约」', place: '东京 · 豪华酒店',
    summary: '黑之魔王夜宿心叶床上闹出「夫妻相声」，随后认真求婚立约：「要是你最终没能停滞终末……在世界毁灭之前——我们结婚吧。」心叶答应，但在终末前坚持正常恋爱。'
      + '撞见两人差点逆推的艾莉芙拔枪相向。之后连日劳累的会长发烧，心叶彻夜照料喂粥，却在她的化妆包里发现 11 支「短期局部记忆处理剂」与褪色的全家福。',
    entities: ['——'], chars: ['luna'],
    bond: B({ hikari: 92, luna: 97, mefisa: 90, nyau: 82 }),
  },
  {
    id: 'v3-6', group: '卷3', order: 6, phase: '第 5 话', day: '',
  ...
  {
    id: 'v3-7', group: '卷3', order: 7, phase: '第 6 话', day: '',
  ...
  {
    id: 'v3-8', group: '卷3', order: 8, phase: '第 7 话', day: '',
    title: '百鬼夜行', place: '富士山地下300米 · 浅间神社 → 东京夜空',
    summary: '泰尔以活人祭祀解开七支刀封印，召唤出千年前被封印的「怪异之王」。借「万仙阵」再现神仙时代的环境，数百万祖灵喷涌东京——'
      + '鬼、犬神、天狗等共同幻想自「最后一战」复苏，为人类争取了重整的时间。',
    entities: ['NO.0004 怪异之王', 'NO.无 鬼', 'NO.无 犬神'], chars: [],
    bond: B({ hikari: 94, luna: 97, mefisa: 92, nyau: 86 }),
  },
  {
    id: 'v3-9', group: '卷3', order: 9, phase: '终章', day: '',
...
const v4: Evt[] = [
  {
    id: 'v4-1', group: '卷4', order: 1, phase: '序章', day: '',
  ...
  {
    id: 'v4-2', group: '卷4', order: 2, phase: '第 1 话', day: '',
  ...
  {
    id: 'v4-3', group: '卷4', order: 3, phase: '第 2 话', day: '',
  ...
  {
    id: 'v4-4', group: '卷4', order: 4, phase: '第 3 话', day: '',
  ...
  {
    id: 'v4-5', group: '卷4', order: 5, phase: '第 5 话', day: '',
  ...
  {
    id: 'v4-6', group: '卷4', order: 6, phase: '第 7 话', day: '',
  ...
  {
    id: 'v4-7', group: '卷4', order: 7, phase: '第 8 话', day: '',
  ...
  {
    id: 'v4-8', group: '卷4', order: 8, phase: '终章', day: '',
    ...
    summary: '心叶发动「a Session.」与蕾雅合体为「心蕾雅」，分解终末化的黑金狮子。巨匠以自身为苗，汲取线之人遗骸的能量长成覆盖此国的「紫之大树」No,9510，'
      ...
      + '假面心叶托孤女儿「空」给艾梅后含笑死去。卡乌斯众人访苍叙旧——心叶与蕾雅在星夜立下再会之约。',
...
const v5: Evt[] = [
  {
    id: 'v5-1', group: '卷5', order: 1, phase: '序章', day: '',
  ...
  {
    id: 'v5-2', group: '卷5', order: 2, phase: '第 2 话', day: '',
    title: '戒指之梦与异厅的黑衣', place: '真鹤町 → 东京大学研究室 → 异厅',
    summary: '乃梦姐鉴定出戒指（内刻「a Session.」）是密度 29g/cc、地球不存在的物质。异厅检测到现实变动波长而至，抢走戒指、逮捕乃梦姐。'
      + '心叶由此窥见噬鯱者众的另一段人生：乃梦见新长官利光・温彻斯特与怪异之王；草次郎见自己在蓝花岛为少女「空」赴死。',
    entities: ['——'], chars: ['nyau'],
    bond: B({ hikari: 90, luna: 97, mefisa: 90, nyau: 88 }),
  },
  {
    id: 'v5-3', group: '卷5', order: 3, phase: '第 3 话', day: '',
  ...
  {
    id: 'v5-4', group: '卷5', order: 4, phase: '第 4 话', day: '',
    title: '小柴琳的过去', place: '书架曼荼罗 · 藏书房',
    summary: '琳回忆：她幼时被线之人溺杀，被「艾梅学姐」的幽灵救走，在境界领域商会长大，如今率墨西哥黑帮 Voice 袭击书架曼荼罗复仇。'
      + '她与十年来以为已死的喵呜重逢，才知故乡实为苍之学园所救。㐰八请苍之学园攻略禁书「残响的遗骸」——心叶趁夜与露娜、琳走下那本书的阶梯。',
    entities: ['NO,357 残响的遗骸'], chars: ['luna', 'nyau'],
    bond: B({ hikari: 90, luna: 97, mefisa: 90, nyau: 92 }),
  },
  {
    id: 'v5-5', group: '卷5', order: 5, phase: '第 5 话', day: '',
  ...
  {
    id: 'v5-6', group: '卷5', order: 6, phase: '第 6 话', day: '',
  ...
  {
    id: 'v5-7', group: '卷5', order: 7, phase: '第 7 话', day: '',
...
const v6: Evt[] = [
  {
    id: 'v6-1', group: '卷6', order: 1, phase: '序章', day: '',
  ...
  {
    id: 'v6-2', group: '卷6', order: 2, phase: '第 1 话', day: '',
  ...
  {
    id: 'v6-3', group: '卷6', order: 3, phase: '第 2 话', day: '',
    title: '美国，毁灭', place: '苍之学园 会议室',
    summary: '网红直播被「天使之歌」同化的录像公开。Corporations 代理会长菲德拉・雷诺兹分析遗骸与「注视着你」的片羽，主张派刺客并招揽「圣诞老人」。'
      + '恋兔以队长身份被点名出战，心叶同行。',
    entities: ['NO.8999 艾美莉亚·玛克比尔'], chars: ['hikari', 'luna', 'mefisa', 'nyau'],
    bond: B({ hikari: 93, luna: 98, mefisa: 90, nyau: 95 }),
  },
  {
    id: 'v6-4', group: '卷6', order: 4, phase: '第 4 话', day: '',
  ...
  {
    id: 'v6-5', group: '卷6', order: 5, phase: '第 5 话', day: '',
  ...
  {
    id: 'v6-6', group: '卷6', order: 6, phase: '第 7 话', day: '',
  ...
  {
    id: 'v6-7', group: '卷6', order: 7, phase: '第 8 话', day: '',
  ...
  {
    id: 'v6-8', group: '卷6', order: 8, phase: '终章', day: '',
    title: '你好，再见 · 艾美莉亚的冒险', place: '纽约全城 / 宇宙根源',
    summary: '圣诞老人被艾美莉亚刺死，临终赠铃铛遗言「不要舍弃那颗向往魔法的心」。心叶在地下与「失去五感」的艾美莉亚以 a Session. 相融，吞食一亿个后失败。'
...
const ga2t3: Evt[] = [
  {
    id: 's1-3', group: '外传·S1', order: 1, phase: '外传 短篇', day: '', gaAfter: 2,
...
const ga3t4: Evt[] = [
  {
    id: 's1-1', group: '外传·S1', order: 1, phase: '外传 短篇', day: '', gaAfter: 3,
  ...
  {
    id: 's1-2', group: '外传·S1', order: 2, phase: '外传 短篇', day: '', gaAfter: 3,
  ...
  {
    id: 's1-4', group: '外传·S1', order: 3, phase: '外传 短篇', day: '', gaAfter: 3,
    title: '梅尔文·格蕾的超长无人岛生活', place: '泰尔研究室 → 「无人岛」（观测场景）',
    summary: '战后访问期，心叶为迷路的 Corporations 研发员格蕾（被菲德拉砍断左臂后装义肢）带路找泰尔学长，二人被一只烧瓶粘住手掌，「漂流」到热带无人岛。'
  ...
  {
    id: 's1-5', group: '外传·S1', order: 4, phase: '外传 短篇', day: '', gaAfter: 3,
  ...
  {
    id: 's1-6', group: '外传·S1', order: 5, phase: '外传 短篇', day: '', gaAfter: 3,
  ...
  {
    id: 's1-7', group: '外传·S1', order: 6, phase: '外传 短篇', day: '', gaAfter: 3,
    ...
    script: [
      ...
      { who: 'luna', text: '怎么可能觉得你碍事。你是我最重要的人。', note: '— 空教室 · 和好' },
    ],
  },
];
