...
const v2: Evt[] = [
  ...
  {
    id: 'v2-2', group: '卷2', order: 2, phase: '第 1~2 话', day: '',
...
const v3: Evt[] = [
  ...
  {
    id: 'v3-5', group: '卷3', order: 5, phase: '第 3~4 话', day: '',
  ...
  {
    id: 'v3-8', group: '卷3', order: 8, phase: '第 6 话', day: '',
...
const v4: Evt[] = [
  ...
  {
    id: 'v4-5', group: '卷4', order: 5, phase: '第 4 话', day: '',
  ...
  {
    id: 'v4-6', group: '卷4', order: 6, phase: '第 5 话', day: '',
  ...
  {
    id: 'v4-7', group: '卷4', order: 7, phase: '第 7 话', day: '',
  ...
  },
  {
    ...
    summary: '心叶发动「a Session.」与蕾雅合体为「心蕾雅」，分解终末化的黑金狮子。巨匠以自身为苗，汲取线之人遗骸的能量长成覆盖此国的「紫之大树」No,9510，'
      ...
      + '假面心叶将女儿托付给艾梅、嘱其营救，留下「谢谢你……相信我……」后阖目（卷4并未言明女儿之名）。卡乌斯众人访苍叙旧——心叶与蕾雅在星夜立下再会之约。',
